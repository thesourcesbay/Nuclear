...
LEAKED BY: vectless#0001
AUTHOR: nameless (remade by vektor)

This source is nuclear, a 2018 cheat from nameless, vektor got it and pasted it
and this is his source but idk how he can use it because the source looks like broke
You can try to update it/fix it (fixing errors are easy if you can't you're really a big ape)

Somes creds to: Harvey#6998
...
bool AController_SetControlRotation(FRotator rot, uint64_t controller)
{
	...
	auto func = (*(void(__fastcall**)(uint64_t, void*))(VTable + 0x628));
